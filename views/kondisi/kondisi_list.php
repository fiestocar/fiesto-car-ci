...
<html>
    ...
    <body>
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('kondisi/create'),'Tambah', 'class="btn btn-warning"'); ?>
            </div>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('kondisi'); ?>" class="btn btn-warning">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<?php echo anchor(site_url('kondisi/excel'), 'Excel', 'class="btn btn-warning"'); ?>
		<?php echo anchor(site_url('kondisi/word'), 'Word', 'class="btn btn-warning"'); ?>
	    </div>
